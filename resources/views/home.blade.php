...
@section('content')
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 col-md-12 f-l">
                    <h3 class="work-title">on-demand graphic<br>design service</h3>
                    <div class="work-list">
                    ...
                    <div class="work-list">
                        <div class="list d-flex ">
                            <i class='bx bx-check'></i>
                            <h4 class="point">you decide for how long</h4>
                        </div>
                    </div>
                    <div class="work-list">
                        <div class="list d-flex ">
                            <i class='bx bx-check'></i>
                            <h4 class="point">variety of graphic services</h4>
                        </div>
                    </div>

                    <div class="buttons">
                        <button class="btns" type="submit"><a href="{{url('pricing')}}">see
                                pricing</a></button>
                        <button class="btns " type="submit"><a href="{{url('work')}}">see in
                                action</a></button>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="service-box  p-lg-5 p-4">
                        ...
                        <div>
                            ...
                            <p class="work-para"> we'll assign the best designer for the job.
                ...
                <div class="col-lg-4">
                    <div class="service-box  p-lg-5 p-4">
                        ...
                        <div>
                            ...
                            <p class="work-para"> Get your design between 24 - 48 hours submit as many revision as you
                                want untill you are happy
                ...
                <div class="col-lg-4">
                    <div class="service-box  p-lg-5 p-4">
                        ...
                        <div>
                            ...
                            <p class="work-para">Download all the desing and source files and immediately once its done
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column ps-lg-5">
                    ...
                    <p class="con-para">Kiwi Design is a team of professionals, who will satisfy your needs fast and
                        easy.
                    </p>
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                With Kiwi Design you can order ulimited number of designs. You can order
                                                even 100! Unlimited revisions allow you to create exactly what you need.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Time is priceless! Kiwi Design is answering your requests in one or two
                                                bussines days in most cases.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapsefour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Kiwi Design team will respond to all your questions quickly, in friendly
                                                manner.
            ...
            <div class="container">
                ...
                <div class="row my-5">
                    <div class="col-12 text-center">
                        <h1 class="title-one">simple pricing with no surprise</h1>
                    </div>
                </div>
                    ...
                    <div class="pricing-card">
                        ...
                        <div class="pricing-card_content">
                            <ul>
                                ...
                                <li class=""><i class="fa fa-check"></i><strong> 1-2 days
                                        turnaround</strong></li>
                                ...
                                <li class="ps-4">prioritized support</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12  my-4 plan">
                        ...
                        <h1 class="des-c"><a class="des-c" href="#contacts">contact us!</a></h1>
                    </div>
                </div>
        </section>
    </section>
    ...
    <section id="check-work">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="c-t text-center">check out some of <span>our work</span></h1>
                </div>
            </div>
            <div class="row w-100">
                <p class="served">custom illustration, t-shirts, infographics, book cover, brochures, flyers, online-ads, packaging, social media</p>
            </div>
